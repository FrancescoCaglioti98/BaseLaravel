...
<template>
    ...
    >
        <div class="flex flex-col gap-4">
            <div>
                <span class="text-sm text-muted-color font-semibold">Colore Principale</span>
            ...
            <div class="flex flex-col gap-2">
                <span class="text-sm text-muted-color font-semibold">Modalit&aacute; Men&ugrave;</span>
